...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='UnitySheepers ({})'.format(BOTVERSION), icon_url='https://i.imgur.com/feyo0eV.png')
        e.set_author(name=self.user.name, url='https://www.UnitySheepers.x10.mx', icon_url=self.user.avatar_url)
        return e
